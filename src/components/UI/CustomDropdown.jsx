    ...
    <AnimatePresence>
      {isOpen && dropdownRect && (
        <motion.div
          ...
          className="bg-white border border-slate-300 rounded-xl overflow-hidden shadow-2xl"
        >
          {searchable && (
            <div className="p-2 border-b border-slate-200">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-9 pl-9 pr-4 bg-slate-50 border-none rounded-full text-[12px] font-medium focus:outline-none focus:ring-1 focus:ring-med-primary/20 transition-all"
                  autoFocus
                />
              </div>
            </div>
    ...
    <div className={`w-full space-y-1.5 ${className}`} ref={dropdownRef}>
      ...
      <div className="relative h-[inherit]">
        <button
          ...
          className={`w-full min-h-[44px] h-[inherit] px-5 flex items-center justify-between gap-3 bg-white border transition-all rounded-full select-none outline-none
        ...
        >
          <div className="flex items-center gap-3 overflow-hidden">
            ...
            <span className={`text-[13px] font-medium truncate text-[inherit] ${selectedOption ? 'text-[#1e4a3a]' : 'text-slate-400'}`}>
        ...
        {portalElement && createPortal(dropdownList, portalElement)}
      </div>
