...
const slides = [
  {
    ...
    desc: 'Empowering patients through seamless digital access to world-class healthcare.',
  ...
  },
  {
    ...
    desc: 'Real-time health monitoring and data-driven insights for better outcomes.',
    color: 'from-teal-700 to-[#1e4a3a]',
    graphic: (
  ...
  },
  {
    ...
    title: 'Neural Links',
    desc: 'Cutting-edge medical intelligence and AI-assisted clinical diagnosis.',
